...
export const CORRELACOES = [
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    interpretacao: 'Possível redução adaptativa do metabolismo tireoidiano.',
    racionalFisiologico: 'Baixa disponibilidade energética, inflamação e estresse crônico podem impactar conversão T4→T3, sensibilidade metabólica, termogênese e gasto energético basal.',
  },
